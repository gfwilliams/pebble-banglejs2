...
static const BoardConfigButton BOARD_CONFIG_BUTTON = {
  .buttons = {
    ...
    [BUTTON_ID_UP] =
        { "Up",     { NRFX_GPIOTE_INSTANCE(0), 2, NRF_GPIO_PIN_MAP(0, 17) }, NRF_GPIO_PIN_PULLUP },
    [BUTTON_ID_SELECT] =
        { "Select", { NRFX_GPIOTE_INSTANCE(0), 3, NRF_GPIO_PIN_MAP(0, 17) }, NRF_GPIO_PIN_PULLUP },
    [BUTTON_ID_DOWN] =
        { "Down",   { NRFX_GPIOTE_INSTANCE(0), 4, NRF_GPIO_PIN_MAP(0, 17) }, NRF_GPIO_PIN_PULLUP },
  },
  .button_com = { 0 },
  .active_high = false,
...
static const BoardConfigAccel BOARD_CONFIG_ACCEL = {
  ...
  .accel_int_gpios = {
    [0] = { NRF5_GPIO_RESOURCE_EXISTS, NRF_GPIO_PIN_MAP(1, 7) }
  },
  .accel_ints = {
    [0] = { .peripheral = NRFX_GPIOTE_INSTANCE(0), .channel = 6, .gpio_pin = NRF_GPIO_PIN_MAP(1, 7), },
  },
};
